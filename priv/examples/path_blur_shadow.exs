...
draw 720, 420 do
  ...
  shadow_path ring, 14.0, 12.0, 36.0,
    fill: rgb(0, 0, 0, 180),
    padding: 44.0
  ...
  shadow_path star, 10.0, 8.0, 15.0,
    fill: rgb(250, 0, 0, 150),
    padding: 10.0
  ...
  text font, 22, 56, "Options: mode, padding, offset; styles mirror fill/stroke.", fill: rgb(180, 190, 200)
end
