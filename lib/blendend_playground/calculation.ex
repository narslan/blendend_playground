defmodule BlendendPlayground.Calculation do
  ...
  ## Examples
      ...
      iex> v = BlendendPlayground.Calculation.noise2(12.3, 45.6)
      iex> is_float(v) and v >= 0.0 and v < 1.0
      true

      iex> BlendendPlayground.Calculation.noise2(12.3, 45.6) == BlendendPlayground.Calculation.noise2(12.3, 45.6)
      true

      iex> v = BlendendPlayground.Calculation.noise2(-0.2, -3.7)
      iex> v >= 0.0 and v < 1.0
      true
  """
